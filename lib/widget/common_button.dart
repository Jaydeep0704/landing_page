...
commonIconButton({ EdgeInsetsGeometry? margin ,
  EdgeInsetsGeometry? padding,
  double? height, double? width,
  String? title, void Function()? onTap,
  IconData? icon, Color? iconColor,Color? btnColor,
  ...
  return InkWell(
    ...
    child: Container(
      ...
      margin: margin ??  const EdgeInsets.symmetric(horizontal: 30, vertical: 15),
...
commonIconButtonMedium({EdgeInsetsGeometry? margin ,
  EdgeInsetsGeometry? padding,
  double? height,double? width,
  String? title, void Function()? onTap,
  double? fontSize,
  IconData? icon, Color? btnColor,
  Color? iconColor, Color? txtColor}) {
  return InkWell(
    onTap: onTap,
    child: Container(
      height:height ??  40,
...
commonIconButtonSmall({EdgeInsetsGeometry? margin ,
  EdgeInsetsGeometry? padding,
  double? height,double? width,
  String? title, Function()? onTap,
  double? fontSize, IconData? icon,
  Color? iconColor, Color? btnColor, Color? txtColor}) {
  return InkWell(
    onTap: onTap,
    child: Container(
      height:height ??  40,
...
commonButton({ EdgeInsetsGeometry? margin ,
  EdgeInsetsGeometry? padding,
  double? height, double? width,
  String? title, void Function()? onTap,
  IconData? icon, Color? btnColor,
