...
class GetPlanLists {
  GetPlanLists({
    ...
    required this.code,
    required this.per_month_price,
    required this.final_month_price,
  });
  ...
  late final String per_month_price;
  late final String final_month_price;
  ...
  GetPlanLists.fromJson(Map<String, dynamic> json){
    ...
    code = json['code'];
    per_month_price = json['per_month_price'];
    final_month_price = json['final_month_price'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['code'] = code;
    _data['per_month_price'] = per_month_price;
    _data['final_month_price'] = final_month_price;
    return _data;
  }
}