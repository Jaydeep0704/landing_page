// ignore_for_file: avoid_web_libraries_in_flutter, implementation_imports, depend_on_referenced_packages, use_build_context_synchronously, prefer_typing_uninitialized_variables, non_constant_identifier_names, file_names
...
class AddNewTestimonalScreen extends StatefulWidget {
  const AddNewTestimonalScreen({Key? key}) : super(key: key);
  @override
      ...
      builder: (p0, p1) {
        return Scaffold(
          appBar: AppBar(
            ...
            title: const Text("Add Testimonal",
                style: TextStyle(
                    color: Colors.black,
                    fontSize: 18,
