                      ...
                      Align(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            Get.to(()=>AddUpdateCaseStudyDetails(isEdit: false, caseStudyAutoId: widget.shortDescription["case_study_auto_id"],))!.
                            whenComplete(() =>     detailCaseStudyController.getCaseStudyData(caseStudyAutoId: widget.shortDescription["case_study_auto_id"])
                            );
                          },
                          child: FittedBox(
                                  ...
                                  child: Column(
                                   ...
                                   children: [
                                    const SizedBox(height: 10),
                                        ...
                                        GestureDetector(
                                          onTap: () async {
                                            Get.to(()=>AddUpdateCaseStudyDetails(
                                              ...
                                              media:data["media"],
                                              mediaTypeKey: data["mediaTypeKey"],
                                     ...
                                     Row(
                                       children: [
                                         index.isEven ? const SizedBox():mediaComponent(media: data["media"].toString(),mediaType: data["mediaTypeKey"].toString()) ,
                                         ...
                                         index.isOdd ? const SizedBox():mediaComponent(media: data["media"].toString(),mediaType: data["mediaTypeKey"].toString()),
