...
class _WebLandingScreenState extends State<WebLandingScreen> {
    ...
    for (var item in getLatestProject.getProjectList) {
      ...
      if (mediaType == 'video') {
        final controller = VideoPlayerController.network(
            APIString.latestmediaBaseUrl + link);
  ...
  Future<Position> getUserLocation() async {
    ...
    if (permission == LocationPermission.always ||
      ...
      pricingScreenController.getPlansData(lat: position.latitude.toString(),
      ...
      if (editController
        ...
        editIntroController.introBotController =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    .allDataResponse[0]["intro_details"][0]["intro_bot_file"]
                    .toString()));
        await editIntroController.introBotController.initialize()
            .whenComplete(() {
        ...
        editIntroController.introGif1Controller =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    ...
                    .toString()));
        await editIntroController.introGif1Controller.initialize()
            .whenComplete(() {
        ...
        editIntroController.introGif2Controller =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    ...
                    .toString()));
        await editIntroController.introGif2Controller.initialize()
            .whenComplete(() {
  ...
  initializeVideoHIW() async {
    if (editController.allDataResponse.isNotEmpty) {
      ...
      ///------------how it works
      if (editController
          .allDataResponse[0]["how_it_works_details"][0]["hiw_gif_mediatype"]
          .toString()
          .toLowerCase() == "video") {
        editHiwController.botController = VideoPlayerController.networkUrl(
            Uri.parse(APIString.mediaBaseUrl + editController
                .allDataResponse[0]["how_it_works_details"][0]["hiw_gif"]
                .toString()));
  ...
  initializeVideoMixBanner() async {
    if (editController.allDataResponse.isNotEmpty) {
      ...
      ///------------mix banner
      if (editController
          .allDataResponse[0]["mix_banner_details"][0]["mix_banner_file_mediatype"]
          .toString()
          .toLowerCase() == "video") {
        mixBannerController.videoController = VideoPlayerController.networkUrl(
            Uri.parse(APIString.mediaBaseUrl + editController
                .allDataResponse[0]["mix_banner_details"][0]["mix_banner_file"]
                .toString()));
  ...
  initializeVideobenefitBanner() async {
    ...
    if (editController.allDataResponse.isNotEmpty) {
      ...
      ///------------mix banner
      if (editController
          .allDataResponse[0]["benefit_banner_details"][0]["benefit_banner_file_mediatype"]
          .toString()
          .toLowerCase() == "video") {
        benefitBannerController.videoController =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    ...
                    .toString()));
        await benefitBannerController.videoController.initialize()
            .whenComplete(() {
  ...
  initializeVideCheckOut() async {
    ...
    if (editController.allDataResponse.isNotEmpty) {
      ...
      ///------------mix banner
      if (editController
          .allDataResponse[0]["checkout_details"][0]["checkout_file_mediatype"]
          .toString()
          .toLowerCase() == "video") {
        editCheckOutController.checkvideoController =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    ...
                    .toString()));
        await editCheckOutController.checkvideoController.initialize()
            .whenComplete(() {
          // Future.delayed(const Duration(seconds: 2),() {
        ...
        numberBannerController.media1Controller =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    ...
                    .toString()));
        await numberBannerController.media1Controller.initialize()
            .whenComplete(() {
        ...
        numberBannerController.media2Controller =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    ...
                    .toString()));
        await numberBannerController.media2Controller.initialize()
            .whenComplete(() {
        ...
        numberBannerController.media3Controller =
            VideoPlayerController.networkUrl(
                Uri.parse(APIString.mediaBaseUrl + editController
                    ...
                    .toString()));
        await numberBannerController.media3Controller.initialize()
            .whenComplete(() {
          ...
          child: Scaffold(
            ...
            body: SizedBox(
              ...
              child: Obx(() {
                ...
                //       //Phase2
                //       TestimonialsSection(scrollToPricingSection: _scrollToPricingSection,),
                //
                ...
                //       // HelpBannerSection(),
                //
                //       HelpBannerSection(scrollToPricingSection: _scrollToPricingSection,),
                //
                ...
                //
                //       ///twelth part from here - Builder.ai/pricing platform vise price --- pricing
