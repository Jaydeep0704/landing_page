// ignore_for_file: prefer_typing_uninitialized_variables, non_constant_identifier_names, avoid_web_libraries_in_flutter, implementation_imports, implementation_imports, depend_on_referenced_packages, duplicate_ignore, file_names
...
class _EditCheckOutInfoState extends State<EditCheckOutInfo> {
  ...
  Widget displayUploadedVideo() {
    VideoPlayerController vController = VideoPlayerController.networkUrl(
        Uri.parse(APIString.latestmediaBaseUrl + widget.fileData));
